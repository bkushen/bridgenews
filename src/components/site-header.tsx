...
export async function SiteHeader() {
  ...
  return <header data-public-header className="sticky top-0 z-50 border-b backdrop-blur">
    <div className="mx-auto flex max-w-[1180px] items-center gap-3 px-4 py-3 sm:px-5">
      <Link href="/" className="mr-auto flex items-center gap-3"><span className="grid h-9 w-9 place-items-center rounded-full bg-[#a5232f] text-[10px] font-black tracking-[-0.08em] text-[#fffaf3] shadow-sm">BN</span><span className="news-wordmark text-[22px] font-black text-[#1d1b19]">{siteName}</span></Link>
