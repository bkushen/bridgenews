  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-10">
      <div className="flex flex-col gap-5 border-b border-gray-200 pb-6 lg:flex-row lg:items-end lg:justify-between">
        <div><p className="text-[11px] font-black uppercase tracking-[0.18em] text-red-600">{edition.flag} {edition.label} · Across publishers</p><h1 className="mt-2 text-4xl font-black tracking-tight md:text-5xl">Top Stories</h1><p className="mt-3 max-w-3xl leading-7 text-gray-600">The biggest current {edition.adjective} stories ranked by independent publisher coverage and report count. Similar headlines are grouped deterministically without AI.</p></div>
